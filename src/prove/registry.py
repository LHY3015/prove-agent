...
class Registry:
    def __init__(
        ...
        *,
        ...
        # check_same_thread=False: the FastAPI service reads/writes the registry from threadpool
        # request handlers, not the thread that opened the connection (single writer at a time).
